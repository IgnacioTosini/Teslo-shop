...
export const AddressForm = ({ countries, userStoreAddress = {} }: Props) => {
    ...
    }, [reset, storeAddress, storeAddress.firstName]);

    const onSubmit = async (data: FormInputs) => {
        const { rememberAddress, ...restAddresss } = data
        setAddress(restAddresss);

        if (rememberAddress) {
            await setUserAddress(restAddresss, session!.user.id)
        } else {
