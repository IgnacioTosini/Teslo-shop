...
export const Sidebar = () => {
    ...
    return (
        <div>
            ...
            {isSideMenuOpen && <div className="fade-in fixed top-0 left-0 w-screen h-screen z-10 backdrop-filter backdrop-blur-sm" onClick={closeSideMenu} />}

            <nav className={
                clsx(
                    "fixed p-5 right-0 top-0 w-125 h-screen bg-white z-20 shadow-2xl tranform transition-all duration-300",
                    {
...

                {
                    isAuthenticated && (
                        <>
                            ...
                            <button className='w-full flex items-center mt-10 p-2 hover:bg-gray-100 rounded transition-all'
                                onClick={() => {
                                    onLogout()
                                    closeSideMenu()
                                }
